...
impl cfn_resources::CfnResource for CfnModelPackage {
    ...
    fn validate(&self) -> Result<(), String> {
        self.additional_inference_specification_definition
            .as_ref()
        ...
        self.model_package_status_item
            .as_ref()
            .map_or(Ok(()), |val| val.validate())?;
        ...
        if let Some(the_val) = &self.model_package_version {
            if *the_val < 1 as _ {
                return Err(format!(
                    "Min validation failed on field 'model_package_version'. {} is less than 1",
                    the_val
                ));
            }
        }
...
impl cfn_resources::CfnResource for SourceAlgorithmSpecification {
    ...
    fn validate(&self) -> Result<(), String> {
        ...
        if the_val.len() > 1 as _ {
            return Err(format!(
                "Max validation failed on field 'source_algorithms'. {} is greater than 1",
                the_val.len()
            ));
        }
...
impl cfn_resources::CfnResource for TransformJobDefinition {
    ...
    fn validate(&self) -> Result<(), String> {
        if let Some(the_val) = &self.max_concurrent_transforms {
            if *the_val < 0 as _ {
                return Err(format!(
                    "Min validation failed on field 'max_concurrent_transforms'. {} is less than 0",
                    the_val
                ));
            }
        }
        ...
        if let Some(the_val) = &self.max_payload_in_mb {
            if *the_val < 0 as _ {
                return Err(format!(
                    "Min validation failed on field 'max_payload_in_mb'. {} is less than 0",
                    the_val
                ));
            }
        }
...
impl cfn_resources::CfnResource for TransformResources {
    ...
    fn validate(&self) -> Result<(), String> {
        ...
        if *the_val < 1 as _ {
            return Err(format!(
                "Min validation failed on field 'instance_count'. {} is less than 1",
                the_val
            ));
        }
...
impl cfn_resources::CfnResource for ValidationSpecification {
    ...
    fn validate(&self) -> Result<(), String> {
        ...
        if the_val.len() > 1 as _ {
            return Err(format!(
                "Max validation failed on field 'validation_profiles'. {} is greater than 1",
                the_val.len()
            ));
        }
