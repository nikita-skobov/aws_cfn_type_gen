...
impl cfn_resources::CfnResource for CfnEventSubscription {
    ...
    fn validate(&self) -> Result<(), String> {
        ...
        if the_val.len() > 2147483647 as _ {
            return Err(format!("Max validation failed on field 'severity'. {} is greater than 2147483647", the_val.len()));
        }
        ...
        if the_val.len() > 2147483647 as _ {
            return Err(format!("Max validation failed on field 'sns_topic_arn'. {} is greater than 2147483647", the_val.len()));
        }
        ...
        if the_val.len() > 2147483647 as _ {
            return Err(format!("Max validation failed on field 'source_type'. {} is greater than 2147483647", the_val.len()));
        }
        ...
        if the_val.len() > 2147483647 as _ {
            return Err(format!("Max validation failed on field 'subscription_name'. {} is greater than 2147483647", the_val.len()));
        }
