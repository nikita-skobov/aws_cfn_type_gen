...
pub struct CfnEventSubscription {
    ...
    pub subscription_name: cfn_resources::StrVal,
...
impl cfn_resources::CfnResource for CfnEventSubscription {
    ...
    fn validate(&self) -> Result<(), String> {
        ...
        if let Some(the_val) = &self.sns_topic_arn {
            if let cfn_resources::StrVal::String(s) = &the_val {
                if s.len() > 2147483647 as _ {
                    return Err(format!("Max validation failed on field 'sns_topic_arn'. {} is greater than 2147483647", s.len()));
                }
            }
        }
        ...
        if let Some(the_val) = &self.source_type {
            if let cfn_resources::StrVal::String(s) = &the_val {
                if s.len() > 2147483647 as _ {
                    return Err(format!("Max validation failed on field 'source_type'. {} is greater than 2147483647", s.len()));
                }
            }
        }
        ...
        if let cfn_resources::StrVal::String(s) = &the_val {
            if s.len() > 2147483647 as _ {
                return Err(format!("Max validation failed on field 'subscription_name'. {} is greater than 2147483647", s.len()));
            }
        }
