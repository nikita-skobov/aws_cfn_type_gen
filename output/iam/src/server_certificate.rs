...
impl cfn_resources::CfnResource for CfnServerCertificate {
    ...
    fn validate(&self) -> Result<(), String> {
        ...
        if the_val.len() > 16384 as _ {
            return Err(format!("Max validation failed on field 'certificate_body'. {} is greater than 16384", the_val.len()));
        }
        ...
        if the_val.len() < 1 as _ {
            return Err(format!("Min validation failed on field 'certificate_body'. {} is less than 1", the_val.len()));
        }
        ...
        if the_val.len() > 16384 as _ {
            return Err(format!("Max validation failed on field 'private_key'. {} is greater than 16384", the_val.len()));
        }
        ...
        if the_val.len() < 1 as _ {
            return Err(format!("Min validation failed on field 'server_certificate_name'. {} is less than 1", the_val.len()));
        }
