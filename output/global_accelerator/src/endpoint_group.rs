    ...
    fn validate(&self) -> Result<(), String> {
        ...
        if let Some(the_val) = &self.health_check_port {
            if *the_val > 65535 as _ {
                return Err(format!(
                    "Max validation failed on field 'health_check_port'. {} is greater than 65535",
                    the_val
                ));
            }
        }
        ...
        if let Some(the_val) = &self.health_check_port {
            if *the_val < 1 as _ {
                return Err(format!(
                    "Min validation failed on field 'health_check_port'. {} is less than 1",
                    the_val
                ));
            }
        }
        ...
        if let Some(the_val) = &self.port_overrides {
            if the_val.len() > 10 as _ {
                return Err(format!(
                    "Max validation failed on field 'port_overrides'. {} is greater than 10",
                    the_val.len()
                ));
            }
        }
        ...
        if let Some(the_val) = &self.threshold_count {
            if *the_val > 10 as _ {
                return Err(format!(
                    "Max validation failed on field 'threshold_count'. {} is greater than 10",
                    the_val
                ));
            }
        }
        ...
        if let Some(the_val) = &self.threshold_count {
            if *the_val < 1 as _ {
                return Err(format!(
                    "Min validation failed on field 'threshold_count'. {} is less than 1",
                    the_val
                ));
            }
        }
...
impl cfn_resources::CfnResource for EndpointConfiguration {
    ...
    fn validate(&self) -> Result<(), String> {
        ...
        if let Some(the_val) = &self.weight {
            if *the_val > 255 as _ {
                return Err(format!(
                    "Max validation failed on field 'weight'. {} is greater than 255",
                    the_val
                ));
            }
        }
...
impl cfn_resources::CfnResource for PortOverride {
    ...
    fn validate(&self) -> Result<(), String> {
        ...
        if *the_val > 65535 as _ {
            return Err(format!(
                "Max validation failed on field 'endpoint_port'. {} is greater than 65535",
                the_val
            ));
        }
        ...
        if *the_val < 1 as _ {
            return Err(format!(
                "Min validation failed on field 'endpoint_port'. {} is less than 1",
                the_val
            ));
        }
        ...
        if *the_val > 65535 as _ {
            return Err(format!(
                "Max validation failed on field 'listener_port'. {} is greater than 65535",
                the_val
            ));
        }
        ...
        if *the_val < 1 as _ {
            return Err(format!(
                "Min validation failed on field 'listener_port'. {} is less than 1",
                the_val
            ));
        }
