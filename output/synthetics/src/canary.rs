...
impl cfn_resources::CfnResource for CfnCanary {
    ...
    fn validate(&self) -> Result<(), String> {
        ...
        if let Some(the_val) = &self.failure_retention_period {
            if *the_val < 1 as _ {
                return Err(format!(
                    "Min validation failed on field 'failure_retention_period'. {} is less than 1",
                    the_val
                ));
            }
        }
        ...
        if let Some(the_val) = &self.success_retention_period {
            if *the_val < 1 as _ {
                return Err(format!(
                    "Min validation failed on field 'success_retention_period'. {} is less than 1",
                    the_val
                ));
            }
        }
    ...
    fn validate(&self) -> Result<(), String> {
        if let Some(the_val) = &self.memory_in_mb {
            if *the_val > 3008 as _ {
                return Err(format!(
                    "Max validation failed on field 'memory_in_mb'. {} is greater than 3008",
                    the_val
                ));
            }
        }
        ...
        if let Some(the_val) = &self.memory_in_mb {
            if *the_val < 960 as _ {
                return Err(format!(
                    "Min validation failed on field 'memory_in_mb'. {} is less than 960",
                    the_val
                ));
            }
        }
        ...
        if let Some(the_val) = &self.timeout_in_seconds {
            if *the_val > 840 as _ {
                return Err(format!(
                    "Max validation failed on field 'timeout_in_seconds'. {} is greater than 840",
                    the_val
                ));
            }
        }
        ...
        if let Some(the_val) = &self.timeout_in_seconds {
            if *the_val < 3 as _ {
                return Err(format!(
                    "Min validation failed on field 'timeout_in_seconds'. {} is less than 3",
                    the_val
                ));
            }
        }
