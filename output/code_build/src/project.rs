...
impl cfn_resources::CfnResource for CfnProject {
    ...
    fn validate(&self) -> Result<(), String> {
        ...
        self.build_batch_config.as_ref().map_or(Ok(()), |val| val.validate())?;
        ...
        if the_val.len() > 255 as _ {
            return Err(format!("Max validation failed on field 'description'. {} is greater than 255", the_val.len()));
        }
        ...
        self.logs_config.as_ref().map_or(Ok(()), |val| val.validate())?;
        ...
        if *the_val < 5 as _ {
            return Err(format!("Min validation failed on field 'queued_timeout_in_minutes'. {} is less than 5", the_val));
        }
        ...
        if the_val.len() < 1 as _ {
            return Err(format!("Min validation failed on field 'resource_access_role'. {} is less than 1", the_val.len()));
        }
        ...
        if the_val.len() > 12 as _ {
            return Err(format!("Max validation failed on field 'secondary_artifacts'. {} is greater than 12", the_val.len()));
        }
        ...
        if the_val.len() > 12 as _ {
            return Err(format!("Max validation failed on field 'secondary_sources'. {} is greater than 12", the_val.len()));
        }
        ...
        if the_val.len() < 1 as _ {
            return Err(format!("Min validation failed on field 'service_role'. {} is less than 1", the_val.len()));
        }
        ...
        if *the_val > 480 as _ {
            return Err(format!("Max validation failed on field 'timeout_in_minutes'. {} is greater than 480", the_val));
        }
        ...
        if *the_val < 5 as _ {
            return Err(format!("Min validation failed on field 'timeout_in_minutes'. {} is less than 5", the_val));
        }

        }
        
        self.triggers.as_ref().map_or(Ok(()), |val| val.validate())?;
...
impl cfn_resources::CfnResource for Environment {
    ...
    fn validate(&self) -> Result<(), String> {
        ...
        self.registry_credential.as_ref().map_or(Ok(()), |val| val.validate())?;
...
impl cfn_resources::CfnResource for RegistryCredential {
    ...
    fn validate(&self) -> Result<(), String> {
        ...
        if the_val.len() < 1 as _ {
            return Err(format!("Min validation failed on field 'credential'. {} is less than 1", the_val.len()));
        }
...
impl cfn_resources::CfnResource for Source {
    ...
    fn validate(&self) -> Result<(), String> {
        ...
        self.build_status_config.as_ref().map_or(Ok(()), |val| val.validate())?;

        if let Some(the_val) = &self.git_clone_depth {

        if *the_val < 0 as _ {
            return Err(format!("Min validation failed on field 'git_clone_depth'. {} is less than 0", the_val));
        }

        }
        
        self.git_submodules_config.as_ref().map_or(Ok(()), |val| val.validate())?;
