...
pub struct CfnAssessmentTemplate {
    ...
    pub att_arn: CfnAssessmentTemplatearn,
}

#[derive(Clone, Debug, Default, serde::Serialize, serde::Deserialize)]
pub struct CfnAssessmentTemplatearn;
impl CfnAssessmentTemplatearn {
...
impl cfn_resources::CfnResource for CfnAssessmentTemplate {
    ...
    fn validate(&self) -> Result<(), String> {
        ...
        if *the_val > 86400 as _ {
            return Err(format!(
                "Max validation failed on field 'duration_in_seconds'. {} is greater than 86400",
                the_val
            ));
        }
        ...
        if *the_val < 180 as _ {
            return Err(format!(
                "Min validation failed on field 'duration_in_seconds'. {} is less than 180",
                the_val
            ));
        }
        ...
        if the_val.len() > 50 as _ {
            return Err(format!(
                "Max validation failed on field 'rules_package_arns'. {} is greater than 50",
                the_val.len()
            ));
        }
