...
pub struct CfnDBParameterGroup {
    ...
    pub att_dbparameter_group_name: CfnDBParameterGroupdbparametergroupname,
}

#[derive(Clone, Debug, Default, serde::Serialize, serde::Deserialize)]
pub struct CfnDBParameterGroupdbparametergroupname;
impl CfnDBParameterGroupdbparametergroupname {
    pub fn att_name(&self) -> &'static str {
        r#"DBParameterGroupName"#
    }
}
